...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Main */}
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className=" container px-4 md:px-6 mx-auto">
          <div className=" flex flex-col items-center justify-center space-y-4 text-center">
            <div className=" space-y-2">
              ...
              <p className=" max-w-[700px] text-gray-50 md:text-xl dark:text-gray-400">
                Our AI-powered platform transforms how you handle reciepts and track expenses.
              </p>
            </div>
        ...
        <div className=" container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-800 dark:bg-gray-950">
              ...
              <div className="mt-4">
                <p className="text-4xl font-bold">999.00</p>
                <p className="text-gray-500 dark:text-gray-400">/month</p>
              </div>
              <ul className="mt-6 space-y-2 flex-1">
                <li className="flex items-center">
                ...
                <li className="flex items-center">
                  <Check className="text-green-500 h-5 w-5 mr-2"/>
                  <span>Advance Expert options</span>
                </li>
                <li className="flex items-center">
                  <Check className="text-green-500 h-5 w-5 mr-2"/>
